...
public class InterviewController {
    ...
    public List<InterviewEntity> findAllInterview(@RequestParam String keyword) {
        return interviewRepository.findByInterviewTitleContainingOrIntervieweeContainingOrSubtitleContainingOrNumRockContaining(keyword, keyword, keyword, keyword);
    }
}
