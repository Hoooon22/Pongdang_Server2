...
public class InterviewController {
    ...
    public List<InterviewEntity> findAllInterview(@RequestParam String keyword) {
        return interviewRepository.findByInterviewTitleContainingOrIntervieweeContainingOrSubtitleContainingOrNumRockContainingOrLinkContaining(keyword, keyword, keyword, keyword, keyword);
    }
}
